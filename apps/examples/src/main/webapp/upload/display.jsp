...
<h3>Request Parameters</h3>
    ...
    <b>The Text:</b>&nbsp;<%=  ResponseUtils.filter(request.getParameter("theText")) %><br>
    <b>Write File:</b>&nbsp;<%=  ResponseUtils.filter(request.getParameter("writeFile")) %><br>
    <b>File Path:</b>&nbsp;<%=  ResponseUtils.filter(request.getParameter("filePath")) %><br>
